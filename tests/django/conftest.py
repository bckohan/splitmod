...
def merged():
    ...
    from tests.django.settings import merged as _merged  # noqa: WPS433
...
def stacked():
    ...
    from tests.django.settings import stacked as _stacked  # noqa: WPS433
...
def recursion():
    ...
    from tests.django.settings import recursion as _recursion  # noqa: WPS433
